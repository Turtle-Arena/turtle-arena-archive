...
#define CHARACTERISTIC_AIM_ACCURACY_GUN				8	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER 9	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER	10	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER	11	//float [0, 1]
#else
...
#ifdef TMNTWEAPONS // BOTCODE
#define CHARACTERISTIC_AIM_SKILL					12	//float [0, 1]
//weapon specific aim skill
#define CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER	13	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER		14	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER		15	//float [0, 1]
#else
...
//    OK it turns out that THIS file is used in pak0.pk3/botlib/chars.h and the
//    bot lib supports defines, but not enums?

//file with chats
#define CHARACTERISTIC_CHAT_FILE					16	//string
//name of the chat character
#define CHARACTERISTIC_CHAT_NAME					17	//string
//characters per minute type speed
#define CHARACTERISTIC_CHAT_CPM						18	//integer [1, 4000]
//tendency to insult/praise
#define CHARACTERISTIC_CHAT_INSULT					19	//float [0, 1]
//tendency to chat misc
#define CHARACTERISTIC_CHAT_MISC					20	//float [0, 1]
//tendency to chat at start or end of level
#define CHARACTERISTIC_CHAT_STARTENDLEVEL			21	//float [0, 1]
//tendency to chat entering or exiting the game
#define CHARACTERISTIC_CHAT_ENTEREXITGAME			22	//float [0, 1]
//tendency to chat when killed someone
#define CHARACTERISTIC_CHAT_KILL					23	//float [0, 1]
//tendency to chat when died
#define CHARACTERISTIC_CHAT_DEATH					24	//float [0, 1]
//tendency to chat when enemy suicides
#define CHARACTERISTIC_CHAT_ENEMYSUICIDE			25	//float [0, 1]
//tendency to chat when hit while talking
#define CHARACTERISTIC_CHAT_HITTALKING				26	//float [0, 1]
//tendency to chat when bot was hit but didn't dye
#define CHARACTERISTIC_CHAT_HITNODEATH				27	//float [0, 1]
//tendency to chat when bot hit the enemy but enemy didn't dye
#define CHARACTERISTIC_CHAT_HITNOKILL				28	//float [0, 1]
//tendency to randomly chat
#define CHARACTERISTIC_CHAT_RANDOM					29	//float [0, 1]
//tendency to reply
#define CHARACTERISTIC_CHAT_REPLY					30	//float [0, 1]
//========================================================
//movement
//========================================================
//tendency to crouch
#define CHARACTERISTIC_CROUCHER						31	//float [0, 1]
//tendency to jump
#define CHARACTERISTIC_JUMPER						32	//float [0, 1]
//tendency to walk
#define CHARACTERISTIC_WALKER						33	//float [0, 1]
//tendency to jump using a weapon
#define CHARACTERISTIC_WEAPONJUMPING				34	//float [0, 1]
//tendency to use the grapple hook when available
#define CHARACTERISTIC_GRAPPLE_USER					35	//float [0, 1]	//use this!!
//========================================================
//goal
//========================================================
//item weight file
#define CHARACTERISTIC_ITEMWEIGHTS					36	//string
//the aggression of the bot
#define CHARACTERISTIC_AGGRESSION					37	//float [0, 1]
//the self preservation of the bot (rockets near walls etc.)
#define CHARACTERISTIC_SELFPRESERVATION				38	//float [0, 1]
//how likely the bot is to take revenge
#define CHARACTERISTIC_VENGEFULNESS					39	//float [0, 1]	//use this!!
//tendency to camp
#define CHARACTERISTIC_CAMPER						40	//float [0, 1]
//========================================================
//========================================================
//tendency to get easy frags
#define CHARACTERISTIC_EASY_FRAGGER					41	//float [0, 1]
//how alert the bot is (view distance)
#define CHARACTERISTIC_ALERTNESS					42	//float [0, 1]
//how much the bot fires it's weapon
#define CHARACTERISTIC_FIRETHROTTLE					43	//float [0, 1]
