This directory contains replacement data for quake3 that is no longer used by Turtle Arena.

So if I ever decide to try and run Turtle Arena with a unmodified ioquake3 (Need the PNG and Ogg Vobis support) there is some data here.
