...
/*
Turtle Man: Modified for TMNT weapons and fixed tabs.

NOTE: This file uses "bots/raph_t.c" for the chat file because default_t.c doesn't have any chat strings.
*/
...
skill 1
{
	...
	CHARACTERISTIC_AIM_ACCURACY_GUN						0.3
	CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER		0.3
	CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER			0.3
	CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER			0.3
	CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER			0.3
	CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER				0.3
	CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER				0.3
...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER		0.75
	CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER			0.75
	CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER			0.75
	CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER			0.75
	CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER				0.75
	CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER				0.75
