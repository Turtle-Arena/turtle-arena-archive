...
/*
Based on Open Arena's gargoyle
Modified for TMNT weapons and fixed tabs.
 - Turtle Man
*/

skill 1
{
	CHARACTERISTIC_NAME							"Raph"
	CHARACTERISTIC_GENDER						"Male"
	CHARACTERISTIC_ATTACK_SKILL					0.250
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/raph_w.c"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/raph_i.c"
	...
	CHARACTERISTIC_AIM_ACCURACY_GUN						0.5
	CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER		0.45
	CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER			0.5
	CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER			0.3
	CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER			0.5
	CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER				0.5
	CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER				0.5
...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_GUN						0.9
	CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER		0.9
	CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER			0.9
	CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER			0.75
	CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER			0.9
	CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER				0.9
	CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER				0.9
...
skill 5
{
	...
	CHARACTERISTIC_AIM_ACCURACY_GUN						1.0
	CHARACTERISTIC_AIM_ACCURACY_ELECTRICLAUNCHER		1.0
	CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER			1.0
	CHARACTERISTIC_AIM_ACCURACY_HOMINGLAUNCHER			0.9
	CHARACTERISTIC_AIM_SKILL_ELECTRICLAUNCHER			1.0
	CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER				1.0
	CHARACTERISTIC_AIM_SKILL_HOMINGLAUNCHER				1.0
