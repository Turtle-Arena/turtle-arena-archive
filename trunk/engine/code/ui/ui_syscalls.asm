...
equ trap_R_NumberOfJoints					-87
equ trap_R_JointIndexForName				-88
equ trap_R_SetupSkeleton					-89
equ trap_R_SetupPlayerSkeleton				-90
equ trap_R_MakeSkeletonAbsolute				-91
